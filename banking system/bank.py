...
product_mapping = {
    'P01': 'Basic Checking Account', 'P02': 'Premium Checking Account', 'P03': 'High-Yield Savings Account',
    'P04': 'Money Market Account', 'P05': 'Standard Credit Card', 'P06': 'Gold Credit Card', 'P07': 'Platinum Credit Card',
    'P08': 'Business Credit Card', 'P09': 'Personal Loan', 'P010': 'Home Loan', 'P011': 'Car Loan', 'P012': 'Education Loan',
    'P013': 'Mortgage', 'P014': 'Personal Loan', 'P015': 'Fixed Deposit', 'P016': 'Recurring Deposit', 'P017': 'Investment Fund',
    'P018': 'Car Loan', 'P019': 'Home Equity Loan', 'P020': 'Gold Loan', 'P021': 'Travel Insurance', 'P022': 'Health Insurance',
    'P023': 'Life Insurance', 'P024': 'Pet Insurance', 'P025': 'Business Loan', 'P026': 'Overdraft Protection',
    'P027': 'Wealth Management Service', 'P028': 'Retirement Account', 'P029': 'Savings Account', 'P030': 'Gold Loan',
    'P031': 'Student Loan', 'P032': 'Credit Line', 'P033': 'Investment Advisory', 'P034': 'Fixed Deposit', 'P035': 'Trust Services',
    'P036': 'Real Estate Investment', 'P037': 'Online Savings Account', 'P038': 'Premium Savings Account', 'P039': 'Cash Management Account',
    'P040': 'Luxury Credit Card', 'P041': 'Gold Investment', 'P042': 'Mutual Fund', 'P043': 'Bonds', 'P044': 'Stocks',
    'P045': 'Foreign Exchange Services', 'P046': 'Financial Planning', 'P047': 'Estate Planning', 'P048': 'Long-Term Care Insurance',
    'P049': 'Short-Term Investment', 'P050': 'Tax Planning'
}
...
selected = option_menu("", ["LOAN DEFAULT PREDICTION", "CUSTOMER SEGMENTATION", "PRODUCT RECOMMENDATIONS"],
                       icons=["exclamation-triangle", "people", "star"], orientation="horizontal")
...
background_image_path = 'image2.avif' 
base64_image = get_base64_of_bin_file('image2.avif')
page_bg_img = f"""
<style>
...
if selected == "LOAN DEFAULT PREDICTION":
    ...
    with col2:
        ...
        if st.button("Predict"):
            ...
            input_sample = input_data[["Age", "Monthly_Income", "Credit_Score", "Credit_Score_Band", "Loan_Amount",
                                       "Interest_Rate", "Loan_Term", "Loan_Type", "Debt_Income_log"]]
...
if selected == "CUSTOMER SEGMENTATION":
    ...
    with col2:
        ...
        if st.button("Predict Cluster"):
            ...
            st.markdown(
                f"<h3 style='color: #FFFFFF;'>Cluster Summary</h3>",
                unsafe_allow_html=True
            )
...
if selected == "PRODUCT RECOMMENDATIONS":
    ...
    with col2:
        ...
        if st.button("Recommend Products"):
            recommended_products = recommend_products(customer_id, model_recom, df, product_mapping)
